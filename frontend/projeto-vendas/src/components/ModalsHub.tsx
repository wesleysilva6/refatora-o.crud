...
export type Topico = { id: number; nome_topico: string };
    ...
    <>
      ...
      <div className={`modal fade`} ref={rTopico} tabIndex={-1}>
        <div className="modal-dialog">
          ...
          <div className="modal-body">
            <input className={`form-control ${styles.formControl}`} placeholder="Nome do tópico"
                  value={topicoNome} onChange={e => setTopicoNome(e.target.value)} />
          </div>
          <div className="modal-footer">
            <button className="btn btn-secondary" onClick={() => hide(rTopico.current)}>Cancelar</button>
          ...
          <form onSubmit={salvarProdutoNovo}>
            <div className="modal-body">
              <div className="row g-2">
                <div className="col-md-6"><input name="nome_produto" required className={`form-control ${styles.formControl}`} placeholder="Produto" /></div>
                <div className="col-md-3"><input name="preco" required type="number" step="0.01" className={`form-control ${styles.formControl}`} placeholder="Preço" /></div>
                <div className="col-md-3"><input name="quantidade" required type="number" className={`form-control ${styles.formControl}`} placeholder="Quantidade" /></div>
                <input type="hidden" name="topico_id" value={ctxTopicoId ?? ""} />
                <div className="col-12"><textarea name="descricao" className={`form-control ${styles.formControl}`} placeholder="Descrição" /></div>
                <div className="col-12"><input name="imagem" type="file" accept="image/*" className={`form-control ${styles.formControl}`}/></div>
              </div>
            </div>
            <div className="modal-footer">
              <button className="btn btn-secondary" type="button" onClick={() => hide(rNovo.current)}>Cancelar</button>
      ...
      <div className="modal fade" ref={rEdit} tabIndex={-1}>
        <div className="modal-dialog modal-lg">
          ...
          <form onSubmit={salvarEdicaoProduto}>
            <div className="modal-body">
              <div className="row g-2">
                <div className="col-md-6"><input name="nome_produto" defaultValue={editProduto?.nome_produto ?? ""} className={`form-control ${styles.formControl}`} /></div>
                <div className="col-md-3"><input name="preco" type="number" step="0.01" defaultValue={editProduto?.preco ?? 0} className={`form-control ${styles.formControl}`} /></div>
                <div className="col-md-3"><input name="quantidade" type="number" defaultValue={editProduto?.quantidade ?? 1} className={`form-control ${styles.formControl}`} /></div>
                <div className="col-12"><textarea name="descricao" defaultValue={editProduto?.descricao ?? ""} className={`form-control ${styles.formControl}`} /></div>
                <div className="col-12"><input name="imagem" type="file" accept="image/*" className={`form-control ${styles.formControl}`} /></div>
              </div>
            </div>
            <div className="modal-footer">
              <button className="btn btn-secondary" type="button" onClick={() => hide(rEdit.current)}>Cancelar</button>
              <button className="btn btn-primary" type="submit">Salvar</button>
            </div>
          </form>
        </div>
      ...
      <div className="modal fade" ref={rDelP} tabIndex={-1}>
        <div className="modal-dialog">
          ...
          <div className="modal-footer">
            <button className="btn btn-secondary" onClick={() => hide(rDelP.current)}>Cancelar</button>
      ...
      <div className="modal fade" ref={rDelT} tabIndex={-1}>
        <div className="modal-dialog">
          ...
          <div className="modal-footer">
            <button className="btn btn-secondary" onClick={() => hide(rDelT.current)}>Cancelar</button>
      ...
      <div className="modal fade" ref={rImg} tabIndex={-1}>
        <div className="modal-dialog modal-dialog-centered"><div className="modal-content">
          {imgUrl && (
            <img src={imgUrl} alt="preview" style={{ maxHeight: "80vh", objectFit: "contain" }} />
          )}
        </div></div>
      </div>
    </>
